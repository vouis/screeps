...
export const find_container_trans = function (creep, sourceId, structureId,resourceType=RESOURCE_ENERGY) {
    const source = Game.getObjectById(sourceId);
...
export const find_structure_or_source = function (creep, sourceId, structureId, storageId,resourceType=RESOURCE_ENERGY) {
    const structure = Game.getObjectById(structureId);
    const storage = Game.getObjectById(storageId);
    const source = Game.getObjectById(sourceId)
